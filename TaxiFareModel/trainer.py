...
class Trainer(object):
    ...
    def set_pipeline(self):
        ...
        pipe_distance = make_pipeline(DistanceTransformer(
            distance_type=dist, **DIST_ARGS), StandardScaler())
        ...
        pipe_distance_to_center = make_pipeline(
            DistanceToCenter(), StandardScaler())
    ...
    def evaluate(self):
        ...
        if self.split:
            ...
            print(colored("rmse train: {} || rmse val: {}".format(
